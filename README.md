...
The goal of this project was to recreate the classic **Minesweeper** game using MATLAB, focusing on:

- Game logic and state management
- Graphical user interface design in MATLAB
- Event handling and user interaction
- Clean and maintainable academic code
...
- **MATLAB** (with basic GUI support enabled)
